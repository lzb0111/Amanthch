...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateBilingualMetadata(
    'GannWheel 博客 - 外汇交易知识与市场洞察丨GannWheel丨外汇交易员培训、全职交易员培训',
    'GannWheel Blog - Forex Trading Insights & Market Analysis丨GannWheel丨Forex Trader Training, Full-Time Trader Training',
