...
export const leverageMarginContent = {
  zh: {
    ...
    ctaDescription: '加入 GannWheel 培训，掌握职业交易员的风险控制技巧',
  ...
  en: {
    title: 'Leverage and Margin Explained丨GannWheel丨Day Trader Training, Forex Trader Training',
    ...
    ctaDescription: 'Join GannWheel training to learn professional risk control techniques',
