...
const WelcomeModal = forwardRef<WelcomeModalHandle>((props, ref) => {
  ...
  const bilibiliEmbedUrl =
    "//player.bilibili.com/player.html?isOutside=true&aid=258136585&bvid=BV19a411X7eY&cid=767139112&p=1";
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2
                className={
                  isMinimized ? "text-sm font-bold" : "text-xl font-black"
                }
              >
                {isMinimized
                  ? isZh
              ...
              {isExpanded && (
                <p className="text-xs text-gray-300 dark:text-gray-700">
                  {isZh
                    ? "了解职业交易员职位，开启你的交易生涯"
                    : "Learn about professional trading careers"}
                </p>
              )}
            </div>
          </div>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-black dark:text-white mb-2">
                    {isZh
                      ? "百万美金交易员的真实故事"
                      : "Million Dollar Trader - True Story"}
                  </h3>
                  ...
                  {!submitted ? (
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-black dark:text-white">
                            {isZh
                              ? "填写邮箱，立即获取资料"
                              : "Enter Email to Get Resources"}
                          </h4>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            {isZh
                              ? "我们将把资料发送到您的邮箱"
                              : "We will send resources to your email"}
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <input
                          ...
                          value={
                            isZh
                              ? "交易资料领取 - 欢迎弹窗"
                              : "Trading Resources Request - Welcome Modal"
                          }
                        />
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        {isZh
                          ? "资料已发送到您的邮箱，请查收。"
                          : "Resources have been sent to your email."}
                      </p>
                    </div>
                  )}
                </div>
