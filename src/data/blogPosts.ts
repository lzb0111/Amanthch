...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">江恩轮采用军事化管理模式，因为我们深知：交易是一场心理战争，需要极强的纪律性、执行力和心理素质。我们的培训不是教你如何快速致富，而是培养你成为一名专业的、可持续盈利的交易员。</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">GannWheel adopts a military-style management model because we know: trading is a psychological war requiring extreme discipline, execution, and mental strength. Our training isn't about teaching you how to get rich quick, but cultivating you to become a professional, sustainable trader.</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">GannWheel is not just a training institution, but more like a highly disciplined military camp. We won't promise you quick riches or easy success. What we can provide is:</p>
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">GannWheel Recommendation: Swing Trading Strategy</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">Real trading record from an GannWheel student (anonymized)</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
