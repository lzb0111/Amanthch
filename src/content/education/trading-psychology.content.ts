...
export const tradingPsychologyContent = {
  zh: {
    title: '交易心理学丨江恩轮（GannWheel）丨职业交易员培训、全职交易员培训',
    ...
    ctaTitle: '想要系统提升交易心理？',
    ctaDescription: '加入 GannWheel 交易心理培训，获取专业心理评估和一对一心理辅导',
  ...
  en: {
    title: 'Trading Psychology丨GannWheel丨Professional Trader Training, Full-Time Trader Training',
    ...
    ctaDescription: 'Join GannWheel trading psychology training for professional psychological assessment and one-on-one counseling',
