...
export const priceActionContent = {
  zh: {
    ...
    ctaDescription: '加入GannWheel专业培训，学习裸K交易和供需区域策略',
  ...
  en: {
    title: 'Price Action Trading Strategy丨GannWheel丨Forex Trader Training, Full-Time Trader Training',
    ...
    ctaDescription: 'Join GannWheel professional training to learn naked trading and supply/demand strategies',
