            ...
            <div className="text-center md:text-left">
              <p className="text-base md:text-lg text-[#ff102a]">
                {isZh ? (
                  ...
                  <>
                    GannWheel is an <span className="font-black text-xl underline decoration-2 underline-offset-4">official partner</span> of <span className="font-bold">EC Markets</span>, <span className="font-bold">TickMill</span>, <span className="font-bold">Binance</span>, <span className="font-bold">FTMO</span>, <span className="font-bold">FundedNext</span>
                  </>
                )}
              </p>
