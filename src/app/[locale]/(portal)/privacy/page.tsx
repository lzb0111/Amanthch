  ...
  const content = {
    zh: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            ...
            "• 反对或限制我们处理您的数据",
            "• 数据可携带权（获取您的数据副本）",
            "如需行使这些权利，请通过 jiangenlun@163.com 联系我们。",
          ],
        },
        {
          title: "7. 第三方服务",
      ...
      riskWarning: {
        title: "风险提示",
        content:
          "外汇交易具有高风险，可能不适合所有投资者。杠杆交易可能导致快速且巨大的损失。请确保您充分了解相关风险，并在必要时寻求独立建议。本网站内容仅供教育和信息参考，不构成投资建议。",
      },
    },
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            ...
            "To exercise these rights, please contact us at jiangenlun@163.com",
          ],
        },
        {
