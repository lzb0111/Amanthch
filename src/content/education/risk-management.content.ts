...
export const riskManagementContent = {
  zh: {
    title: '外汇风险管理基础丨江恩轮（GannWheel）丨日内交易员培训、全职交易员培训',
    ...
    ctaTitle: '想要系统学习风险管理？',
    ctaDescription: '加入 GannWheel 培训计划，获取专业风险管理工具和一对一指导',
  ...
  en: {
    title: 'Forex Risk Management Fundamentals丨GannWheel丨Day Trader Training, Full-Time Trader Training',
    ...
    ctaDescription: 'Join GannWheel training program for professional risk management tools and one-on-one guidance',
