...
export const stopLossStrategiesContent = {
  zh: {
    title: '止损策略大全丨江恩轮（GannWheel）丨外汇交易员培训、日内交易员培训',
    ...
    ctaTitle: '想要优化你的止损策略？',
    ctaDescription: '使用 GannWheel 专业止损工具，实现自动化止损管理',
  ...
  en: {
    title: 'Complete Stop Loss Strategies丨GannWheel丨Forex Trader Training, Day Trader Training',
    ...
    ctaDescription: 'Use GannWheel professional stop-loss tools for automated stop management',
