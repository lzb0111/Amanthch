...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    "comparison.emphasis":
      "我们致力于用最短的时间从大量人群中筛选出少数适合做外汇交易的人才并进行培养并给予支持",
    ...
    "joinus.about.timeline":
      "我们将在 30天(20个工作日) 内判断新人是否是做外汇交易的可塑之才：",
    "joinus.about.phase1.title": "前10个工作日",
    ...
    "joinus.plan.phase1.warning":
      " 重要：5 个工作日不能完成规则考核，酌情劝退处理",
    "joinus.plan.phase2.days": "第 6 - 20 个工作日",
    "joinus.plan.phase2.title": "盈利练习",
    "joinus.plan.phase2.desc": "务必不要想法太多，找到适合自己的品种",
    "joinus.plan.phase2.week1":
      "第一周：多练习，找到适合自己的品种（先找4-6个观察，稳定到2个交易品种）",
    "joinus.plan.phase2.week2":
      "第二周：按照盈利考核标准进行盈利练习，不错单、不漏单、不亏损",
    "joinus.plan.phase2.week3":
      "第三周：务必不能犯低级错误，务必做到操作一致性",
    "joinus.plan.phase3.days": "第 21 - 30 个工作日",
    "joinus.plan.phase3.title": "连续盈利考核测试",
    "joinus.plan.phase3.desc":
      "这是最终考核阶段，需要连续10个工作日保持稳定盈利",
    "joinus.plan.phase3.req":
      "盈利考核要求：连续 10 个工作日，每天做到所选交易品种不错单、不漏单、不亏损",
    "joinus.plan.phase3.warning":
      " 重要：30个工作日内不能完成连续 10 天盈利，劝退处理",
    "joinus.plan.phase4.days": "小额实盘 20 工作日",
    "joinus.plan.phase4.title": "小额实盘",
    "joinus.plan.phase4.desc":
      "小额实盘仍旧只有一次机会，超出回撤要求即视为失败，请珍惜",
    "joinus.plan.phase4.1":
      "小额实盘依旧保持盈利考核要求，1-3 品种，不错单，不漏单，不亏损",
    "joinus.plan.phase4.2":
      "认为自己盈利能力不稳定的，可以申请 1-4 周的小额仿真模拟盘固化",
    "joinus.plan.phase4.warning":
      " 重要：小额实盘账户：日回撤不超过 20%，周总回撤不得超过 30%，超过劝退",
    "joinus.plan.phase5.days": "职业交易员阶段",
    "joinus.plan.phase5.title": "大额矩阵（职业交易员）",
    "joinus.plan.phase5.desc": "小额实盘 20 工作日固化无误，进入大额矩阵",
    "joinus.plan.phase5.1":
      " 拥有完全自由的工作时间，每天不限制交易量，保证每日不亏的底线即可",
    "joinus.plan.phase5.2":
      " 资金规模与仓位：随着交易能力的不断稳定，仓位大小逐步提升",
    "joinus.plan.phase5.3": " 小额实盘：20 美金仓位，配资 100 美金",
    "joinus.plan.phase5.4": " 大额实盘：依据小额实盘的表现进行设定",
    "joinus.plan.phase5.5":
      " 仓位增长：随着盈利曲线的上升，逐步增加仓位规模，逐步增加分润比例",
    ...
    "email.tip": "提示：",
    "email.tip.text":
      "请在邮件中包含您的基本信息、教育背景、以及为什么想成为外汇交易员。",
    "email.send": "打开邮件客户端",
    "email.close": "关闭",
    ...
    "dashboard.footer.warning":
      " 仅用于测试环境。实盘交易需要充分测试和风险评估。",
    "dashboard.footer.copyright":
      "2024-2025 © GannWheel 专业外汇交易员培训平台",
    ...
    "unsuitable.pressure.desc":
      "交易需要时间积累和心态培养，急功近利只会导致失败",
    "unsuitable.gambler": '期望通过交易"暴富"或有"赌徒"心态的人',
    "unsuitable.gambler.desc":
      "职业交易是一项严肃的事业，需要理性和纪律，不是赌博",
  ...
  en: {
    ...
    "hero.title": "Professional FX Trader Training Platform",
    "hero.subtitle":
      "Precise, Professional, Efficient - Free Training for True Forex Trading Experts",
    ...
    "why.subtitle":
      "Focused on selecting and cultivating elite forex traders, nurturing those truly suited, retaining the few, and advising the majority to pursue other paths",

    // Advantages
    "advantage.selection.title": "Precise Selection",
    "advantage.selection.desc":
      "Within 30 working days, determine if forex trading is your calling. If not suited, we'll be honest; if suited, we'll invest fully in your development.",
    "advantage.growth.title": "Rapid Growth",
    "advantage.growth.desc":
      "Scientifically avoid common pitfalls, allowing suited individuals to achieve in 30 working days what experts take 10-20 years to accomplish.",
    "advantage.commission.title": "High Commission Structure",
    "advantage.commission.desc":
      "At least 60% of profits belong to you; as your ability grows, this can reach 90% and beyond. Shared success, mutual victory.",
    ...
    "comparison.practical":
      "Practical Training - 30 Days of Systematic Professional Training",
    "comparison.selection":
      "Precise Selection - Direct Advising if Not Suited, No Wasted Time",
    "comparison.funding":
      "Funding Support - Capital Provided Upon Passing Assessment",
    "comparison.share": "High Profit Share - 60%-90% of Profits Go to You",
    "comparison.career":
      "Career Development - Development as Independent Trader or Fund Manager",
    "comparison.discipline":
      "Strict Discipline - Military-Style Management, Professional Development",
    "comparison.highfee":
      "High Tuition - Training Costs Often Reaching Tens of Thousands",
    ...
    "comparison.emphasis":
      "We are dedicated to identifying, from a large population, the few individuals truly suited for forex trading, and providing them with comprehensive development and support in the shortest timeframe possible.",

    // Career Path
    "career.title": "Career Development Path",
    "career.subtitle":
      "30-Day Systematic Development: Complete Path from Novice to Professional Forex Trader",
    "career.stage1.days": "Days 1-5",
    "career.stage1.title": "Rule Learning",
    "career.stage1.desc":
      "Complete 15 standard entry point exercises, master fundamental forex trading system rules",
    "career.stage1.warning":
      " Failure to pass rules assessment within 5 days results in advising to pursue other paths",
    "career.stage2.days": "Days 6-20",
    "career.stage2.title": "Profit Practice",
    "career.stage2.desc":
      "Find suitable currency pairs for yourself, practice according to profitability standards",
    "career.stage2.tip":
      " Maintain operational consistency: no missed entries, no missed exits, no losses",
    "career.stage3.days": "Days 21-30",
    "career.stage3.title": "Profit Assessment",
    "career.stage3.desc":
      "10 consecutive working days of: no missed entries, no missed exits, no losses daily",
    "career.stage3.success":
      " Pass assessment, enter small-amount live trading phase",
    "career.stage4.path": "Small-Amount Live Trading  Large-Amount Matrix",
    "career.stage4.title": "Professional Trader",
    "career.stage4.desc":
      "After 20 working days of small-amount live trading consolidation, enter large-amount matrix",
    "career.stage4.goal":
      " Complete work time freedom, begin independent forex trader career",

    // Requirements
    "req.title": "Do You Meet Basic Requirements",
    "req.subtitle":
      "Strict admission standards ensure training quality - Everyone has only one opportunity to enter",
    ...
    "req.profile.character.desc":
      "Introverted, Steady, Disciplined, Strong Execution",
    ...
    "req.time.environment.desc":
      "Independent Trading Environment, Uninterrupted Focus",
    ...
    "req.online.debrief.desc":
      "Daily 8:00 PM Team Leader Conference Room Debrief",
    ...
    "req.notice.philosophy":
      "We focus on cultivating individuals truly suited for forex trading. In the world of forex trading, some people are inherently unsuited. They rush for success yet don't know what they truly seek; they glance at surfaces then stop, unable to perceive deeper truths. If this describes you, other industries may better suit your strengths.",

    // Video Section
    "video.title": "Understand the Trader Profession",
    "video.subtitle":
      "Traders are freelancers unrestricted by time and space - Deep dive into this profession through documentaries",
    "video.doc1.title": "Million Dollar Trader",
    "video.doc1.rating": "Douban Rating 8.7",
    "video.doc1.desc":
      "This documentary reveals the true process of trader training, from selection to development to becoming a professional trader. Understand the real nature of the trader profession and the qualities needed to become an elite trader.",
    "video.doc1.cta": "Watch Video ",
    "video.doc2.title": "Trader: Instant Millions",
    "video.doc2.rating": "Douban Rating 8.0",
    "video.doc2.desc":
      "In-depth look at traders' daily work and psychological stress, revealing how to make quick decisions in secondary markets, and the psychological and professional skills required. A high-pressure but opportunity-rich profession.",
    ...
    "showcase.screenshots.note":
      "Above are actual student trading profit screenshots",

    // CTA Section
    "cta.title": "Ready to Start Your Forex Trading Career?",
    "cta.subtitle":
      "Remember: The greatest risk is elimination, the cost is time. If clear-headed and ready, schedule an interview. After passing, enter training.",
    "cta.notice.title": "Special Notice",
    "cta.passrate": "Final Pass Rate",
    "cta.passrate.value": "10-15%",
    "cta.passrate.desc":
      "We cultivate those truly suited, retaining the few, advising the majority to pursue other paths",
    ...
    "footer.copyright":
      "© GannWheel · Professional Forex Trader Training Platform",
    "footer.disclaimer":
      " Forex trading carries risk, investment requires caution · Site content for learning reference only, not investment advice",
    ...
    "joinus.hero.subtitle":
      "Cultivating those truly suited, retaining the few, advising the majority to pursue other paths",
    ...
    "joinus.welcome.intro":
      "Having navigated through multiple filters to arrive here, before stepping inside, take time to deeply understand what we offer. Enter only when you believe you meet all requirements.",
    ...
    "joinus.about.desc1":
      "We are a training organization focused on selecting and cultivating elite forex traders. We are committed to identifying, in the shortest time possible, the few individuals from a large population who are suited for forex trading, and providing them with cultivation and support.",
    "joinus.about.desc2":
      "Simply put, we are recruiting forex traders—but not experienced traders with years in the field. Excellent traders don't circulate in the job market; they can only be cultivated personally. In other words, we personally select and train our traders, committed to developing qualified traders into fund managers.",
    "joinus.about.timeline":
      "Within 45 days (30 working days), we will determine whether newcomers have the potential to become forex traders:",
    "joinus.about.phase1.title": "First 20 Working Days",
    "joinus.about.phase1.desc":
      "Including 5 days of basic trading rules learning and 15 days of profit practice",
    ...
    "joinus.about.notfit.desc":
      "We will be honest with you and advise you never to enter secondary markets",
    "joinus.about.fit.title": "If Suited",
    "joinus.about.fit.desc":
      "We will allocate capital to you, recruit you into our organization starting as an independent trader",

    "joinus.videos.title": "Understand the Trader Profession",
    "joinus.videos.desc":
      "Trading is a freelance profession unrestricted by time or space. Gain deeper understanding through these documentaries:",
    "joinus.videos.doc1.rating": "Douban Rating 8.7",
    "joinus.videos.doc1.desc":
      "Reveals the true process of trader training, from selection to cultivation to becoming a professional trader",
    "joinus.videos.doc1.cta": "Watch Documentary ",
    "joinus.videos.doc2.rating": "Douban Rating 8.0",
    "joinus.videos.doc2.desc":
      "In-depth look at traders' daily work and psychological stress, revealing the psychological qualities and professional skills required",
    ...
    "joinus.profile.income.title":
      "About Income, Benefits, Base Salary, and Compensation Structure",
    "joinus.profile.income.desc":
    ...
    "joinus.profile.time.1":
      "Monday to Friday, minimum guaranteed online 1:30 PM - 9:30 PM",
    "joinus.profile.time.2":
      "Beijing Time 8:00 PM team leader conference room debrief",

    "joinus.plan.title": "Development Plan",
    "joinus.plan.phase1.days": "Days 1-5",
    "joinus.plan.phase1.title": "Complete Rules Learning",
    "joinus.plan.phase1.desc":
      "Quickly familiarize yourself with basic trading system rules",
    "joinus.plan.phase1.req":
      "Phase 1 rules assessment requirement: 15 standard entry points without errors",
    "joinus.plan.phase1.warning":
      " Important: Failure to complete rules assessment within 5 working days results in discretionary dismissal",
    "joinus.plan.phase2.days": "Days 6-20",
    "joinus.plan.phase2.title": "Profit Practice",
    "joinus.plan.phase2.desc":
      "Don't overthink; find currency pairs suitable for you",
    "joinus.plan.phase2.week1":
      "Week 1: Practice extensively, find suitable currency pairs (start with 4-6 for observation, stabilize to 2 trading pairs)",
    "joinus.plan.phase2.week2":
      "Week 2: Practice according to profit assessment standards: no missed entries, no missed exits, no losses",
    "joinus.plan.phase2.week3":
      "Week 3: Must avoid elementary mistakes, must achieve operational consistency",
    "joinus.plan.phase3.days": "Days 21-30",
    "joinus.plan.phase3.title": "Continuous Profit Assessment",
    "joinus.plan.phase3.desc":
      "This is the final assessment phase, requiring 10 consecutive working days of stable profitability",
    "joinus.plan.phase3.req":
      "Profit assessment requirement: 10 consecutive working days, daily achievement for selected trading pairs—no missed entries, no missed exits, no losses",
    "joinus.plan.phase3.warning":
      " Important: Failure to complete 10 consecutive profitable days within 30 working days results in dismissal",
    "joinus.plan.phase4.days": "Small-Amount Live 20 Working Days",
    "joinus.plan.phase4.title": "Small-Amount Live Trading",
    "joinus.plan.phase4.desc":
      "Small-amount live trading still has only one chance; exceeding drawdown requirements is considered failure. Please cherish it.",
    "joinus.plan.phase4.1":
      "Small-amount live trading maintains profit assessment requirements: 1-3 currency pairs, no missed entries, no missed exits, no losses",
    "joinus.plan.phase4.2":
      "Those who feel their profitability is unstable can apply for 1-4 weeks of small-amount simulation consolidation",
    "joinus.plan.phase4.warning":
      " Important: Small-amount live account: daily drawdown not exceeding 20%, weekly total drawdown not exceeding 30%, exceeding results in dismissal",
    "joinus.plan.phase5.days": "Professional Trader Phase",
    "joinus.plan.phase5.title": "Large-Amount Matrix (Professional Trader)",
    "joinus.plan.phase5.desc":
      "After 20 working days of small-amount live trading consolidation without errors, enter large-amount matrix",
    "joinus.plan.phase5.1":
      " Complete freedom in working hours, no daily trading volume limits, just maintain the baseline of no daily losses",
    "joinus.plan.phase5.2":
      " Capital Scale & Position: As trading ability stabilizes, position size gradually increases",
    "joinus.plan.phase5.3":
      " Small-amount live: $20 position, $100 capital allocation",
    "joinus.plan.phase5.4":
      " Large-amount live: Determined based on small-amount live performance",
    "joinus.plan.phase5.5":
      " Position growth: As profit curve rises, gradually increase position scale and profit share ratio",
    ...
    "joinus.rules.trading.1":
      "Hard stop-loss lines cannot be moved; positions must be set correctly",
    ...
    "joinus.rules.trading.5":
      "Take-profit lines can only be used with 5x+ profit",
    "joinus.rules.meeting.title": "Meeting Discipline Red Lines",
    "joinus.rules.meeting.1":
      "Students must not add WeChat, phone, or other contact methods",
    "joinus.rules.meeting.2":
      "Maintain seriousness in conference rooms; no discussion of topics other than trading",

    "joinus.final.title": "Final Words",
    "joinus.final.motto":
      "Cultivating those truly suited, retaining the few, advising the majority to pursue other paths.",
    "joinus.final.p1":
      "This is a forex trader military training camp. Here, we will train you into regular forces (pass assessment) through strict military-style management. After passing, we will issue you weapons and ammunition, send you to the frontlines for combat (live trading), and welcome you back victorious (profitable).",
    "joinus.final.p2":
      "Therefore, we will train you very seriously, because no general wishes to sacrifice the soldiers they've painstakingly trained (we won't send unprofitable traders to the frontlines to become cannon fodder).",
    "joinus.final.p3":
      "After passing the assessment, our relationship is one of mutual cooperation and shared success. You can choose to operate independently or back-to-back with comrades. We are not an employer-employee relationship—you are an independent entrepreneur, an independent individual.",
    "joinus.final.highlight":
      "The spoils you capture on the battlefield—at least 60% belong to you personally. As your abilities improve, this ratio will increase, reaching up to 90% and beyond.",
    "joinus.final.p4":
      'Because this is a narrow gate, haven\'t you heard that "free" may be more "expensive" than money? First, once you commit and are selected, professional trading training requires full dedication. Second, those who truly persevere won\'t be burdened by money, but indeed "the road is long and arduous." Third, unlike traditional disciplines, you don\'t need to pay tens of thousands in "tuition"—after all, this is a business of money making money.',

    "joinus.cta.title": "Ready?",
    "joinus.cta.desc":
      "If you're willing to give yourself a chance to realize your life ideals, then:",
    ...
    "faq.contact.desc":
      "Contact our team leader, we will answer your questions as soon as possible",
    ...
    "donate.benefits.desc":
      "90-day professional training, start your professional trader career",
    "donate.benefits.a.title": "Elite Trader Training",
    "donate.benefits.a.desc":
      "Participate in elite trader training courses within the membership community, learn professional trading techniques and strategies, master core market principles",
    "donate.benefits.b.title": "21-Day Coach Guidance",
    "donate.benefits.b.desc":
      "One-on-one professional coaching, 21 days of intensive training, rapidly improve trading abilities, avoid common mistakes",
    "donate.benefits.c.title": "Challenge Advancement Opportunity",
    "donate.benefits.c.desc":
      "Outstanding performers can voluntarily participate in challenges; successful challengers gain lifetime advanced training qualifications and live trading rights",

    "donate.rewards.title": "Challenge Success Rewards",
    "donate.rewards.desc":
      "Prove your strength, gain lifetime career development opportunities",
    "donate.rewards.a.title": "Lifetime Advanced Training",
    "donate.rewards.a.desc":
      "Obtain lifetime advanced training qualification, continuously improve trading skills, become an elite trader, enjoy ongoing professional guidance",
    "donate.rewards.b.title": "$10K-200K MOM Operation Rights",
    "donate.rewards.b.desc":
      "Obtain management authority for $10,000 to $200,000, conduct live trading in the elite matrix club, achieve wealth growth",

    "donate.how.title": "How to Donate",
    "donate.how.desc":
      "After completing the psychology test, contact us via email to obtain the donation address",
    ...
    "donate.how.step4.desc":
      "After completing donation to the provided address, begin your 90-day trial membership training",
    ...
    "donate.notice.1":
      "Donations are voluntary private actions with no commercial commitments or binding force",
    "donate.notice.2": "Trial membership duration: 90 days",
    "donate.notice.3":
      "Participation requirement: Must complete psychology test and pass preliminary screening",
    "donate.notice.4":
      "Challenge opportunity: Outstanding performers can voluntarily participate, not mandatory",

    "donate.modal.title": "Apply for Membership",

    // Psychology Test Page
    "psytest.welcome.title": "Trader Psychology Test",
    "psytest.welcome.subtitle":
      "Comprehensive evaluation of your trading psychological qualities",
    ...
    "psytest.welcome.note":
      "Please answer according to your genuine feelings; there are no right or wrong answers",
    ...
    "psytest.result.rec1.text":
      "Deeply study trading psychology and behavioral finance, understand psychological traps and cognitive biases in trading.",
    "psytest.result.rec2.label": "Record",
    "psytest.result.rec2.title": "Keep Trading Journal",
    "psytest.result.rec2.text":
      "Record in detail the psychological state, decision process and results of each trade; review and summarize regularly.",
    "psytest.result.rec3.label": "Train",
    "psytest.result.rec3.title": "Simulation Training",
    "psytest.result.rec3.text":
      "Exercise decision-making ability and emotional control through simulated trading in a risk-free environment.",
    "psytest.result.rec4.label": "Focus",
    "psytest.result.rec4.title": "Meditation Practice",
    "psytest.result.rec4.text":
      "Practice meditation for 10-15 minutes daily to improve focus and emotional management abilities.",
    "psytest.result.retry": "Retake Test",
    "psytest.result.retry.confirm":
      "Are you sure you want to restart the test? Current results will be lost.",

    "psytest.level.excellent": "Excellent Trader",
    "psytest.level.excellent.desc":
      "You demonstrate outstanding trading psychological qualities. Excellent performance in risk control, emotional management, decision-making ability and other aspects. Continue maintaining this professional trading attitude, and you are likely to become a successful trader.",
    "psytest.level.good": "Good Trader",
    "psytest.level.good.desc":
      "You possess good trading psychological qualities, performing well across multiple dimensions. Through continuous learning and practice, focusing on improving weaknesses, you have significant room for improvement.",
    "psytest.level.pass": "Qualified Trader",
    "psytest.level.pass.desc":
      "You possess basic trading psychological qualities, but some aspects need strengthening. Focus on dimensions with lower scores and improve through learning and training.",
    "psytest.level.improve": "Needs Improvement",
    "psytest.level.improve.desc":
      "Your trading psychological qualities have significant room for improvement. Before engaging in live trading, systematically study trading psychology and exercise psychological qualities through simulated trading.",

    // Email Contact Modal
    "email.default.title": "Forex Trader Interview",
    "email.subject": "Forex Trader Communication",
    "email.description":
      "Please send your resume to the following email address, and we will contact you as soon as possible:",
    ...
    "email.tip": "Tip:",
    "email.tip.text":
      "Please include your basic information, educational background, and why you want to become a forex trader in your email.",
    ...
    "dashboard.footer.warning":
      " For testing environment only. Live trading requires thorough testing and risk assessment.",
    "dashboard.footer.copyright":
      "2024-2025 © GannWheel Professional Forex Trader Training Platform",
    ...
    "notification.message1":
      "Contacted team leader to join forex trader training",
    ...
    "qualification.subtitle":
      "Please carefully assess whether you possess the basic qualifications to become a professional trader",
    "unsuitable.title": "Unsuitable Candidates",
    "unsuitable.subtitle":
      "The following types of candidates are not suitable for our training",
    "unsuitable.pressure":
      "People with financial pressure seeking quick profits from trading",
    "unsuitable.pressure.desc":
      "Trading requires time accumulation and mental cultivation; eagerness for quick success only leads to failure",
    "unsuitable.gambler":
      'People expecting to "get rich quick" or with a "gambler" mentality',
    "unsuitable.gambler.desc":
      "Professional trading is a serious career requiring rationality and discipline, not gambling",
    ...
    "expectations.mindset.desc":
      "Ability to face market fluctuations calmly and execute trading plans decisively",
    "expectations.stable":
      "No current financial troubles, able to pursue trading as a lifelong career",
    "expectations.stable.desc":
      "Stable economic foundation to focus on long-term development",
    "expectations.initiative":
      "High initiative and serious commitment to training",
    "expectations.initiative.desc":
      "Proactive learning, active practice, full dedication to training",

    "assessment.title": "Assessment Focus",
    "assessment.subtitle":
      "Interview and training will assess the following comprehensive abilities",
    "assessment.learning": "Learning Ability",
    "assessment.learning.desc":
      "Ability to quickly understand and master new knowledge",
    "assessment.understanding": "Comprehension",
    "assessment.understanding.desc":
      "Deep understanding of market patterns and trading logic",
    "assessment.execution": "Execution",
    "assessment.execution.desc":
      "Strict execution of trading plans and risk management",
    "assessment.mentality": "Mentality",
    "assessment.mentality.desc":
      "Maintain stable emotions, unaffected by profits and losses",
    "assessment.motivation": "Trading Motivation",
    "assessment.motivation.desc":
      "Correct trading motivation and career pursuit",

    // Blog
    "blog.title": "Trading Blog",
    "blog.subtitle":
      "Professional trading knowledge, practical experience & trading wisdom sharing",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const toggleLanguage = () => {
    ...
    const pathWithoutLocale = pathSegments
      .slice(currentLocale === pathSegments[0] ? 1 : 0)
      .join("/");
