...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return generateBilingualMetadata(
    '职业交易员培训平台丨Apex Traders丨职业交易员培训、外汇交易员培训',
    'Professional Trader Training Platform丨FX Killer丨Professional Trader Training, Forex Trader Training',
    'Apex Traders(FX Killer)专业外汇交易员培训平台，30天系统化培养职业交易员。提供免费职业交易员培训、实战训练和资金支持。通过考核获得资金管理权限，分润高达90%。',
    ...
    '职业交易员培训, 外汇交易员培训, 日内交易员培训, 全职交易员培训, 职业交易员, 外汇交易员, FX Killer, Apex Traders, 交易员培训, 资金管理',
