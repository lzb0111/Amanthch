...
export const swingTradingContent = {
  zh: {
    ...
    ctaTitle: '想要系统学习波段交易？',
    ctaDescription: '加入 GannWheel 培训计划，获取专业波段交易策略和中长期趋势分析',
  ...
  en: {
    title: 'Complete Swing Trading Guide丨GannWheel丨Full-Time Trader Training, Day Trader Training',
    ...
    ctaDescription: 'Join GannWheel training for professional swing trading strategies and medium-term trend analysis',
