...
export const positionSizingContent = {
  zh: {
    ...
    ctaTitle: '想要优化你的仓位管理？',
    ctaDescription: '使用 GannWheel 专业仓位计算工具，实现自动化风险控制',
  ...
  en: {
    title: 'Position Sizing & Money Management丨GannWheel丨Professional Trader Training, Day Trader Training',
    ...
    ctaDescription: 'Use GannWheel professional position calculation tools for automated risk control',
